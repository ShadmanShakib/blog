  ...
  return (
    <section>
      <div className="flex justify-center font-medium">
        <h1 className="w-80 text-center text-3xl leading-relaxed  dark:text-gray-100 ">
      ...
      <div className="mt-8">
        <p className="text-center font-medium text-gray-700 dark:text-gray-400">
          The NextJS Full Stack Devloper with all tools you need to build your SaaS, AI tool, or any
          other web app and make $ online fast.
        </p>
      </div>
